---
title: Mostrar datos UNS con Digital Twin
...
## Digital Twin del taller
En esta sección se busca representar un taller en vivo. Contiene las siguientes máquinas:
- 2 tornos
- 1 brazo robótico que trabaja entre estos tornos
- 1 estación de buffer de entrada y 1 buffer de salida
- 1 verificador de calidad
- 1 sistema de control unificado
- 2 estanterías de materia prima y 2 estanterías de producto
- 1 AGV

## Recopilar datos del taller
Recopila todos los datos en **UNS**, incluidos los datos que controlan movimientos de máquinas, indican estado de máquinas y describen el entorno del taller.
<Steps>
1. Inicia sesión en Tier0, ve a **UNS** y crea los modelos de datos.
        <details className="notebook-cell">
        <summary>Mostrar JSON del modelo UNS</summary>
...
2. Ve a **Flows** y crea un **Source Flow** para conectar fuentes de datos a modelos UNS.
        - Brazo robótico
        <details className="notebook-cell">
        <summary>Mostrar JSON del flow del brazo robótico</summary>
        ...
        - AGV
        <details className="notebook-cell">
        <summary>Mostrar JSON del flow de AGV</summary>
        ...
        - Torno 1
        <details className="notebook-cell">
        <summary>Mostrar JSON del flow del torno 1</summary>
        ...
        - Torno 2
        <details className="notebook-cell">
        <summary>Mostrar JSON del flow del torno 2</summary>
...
<Steps>
1. En Tier0, ve a **Model**.
2. Sube un modelo y selecciona los nodos del modelo a los que quieres mapear datos UNS.
3. Crea una instancia, selecciona el UNS topic para el mapeo del nodo y configura la altura real del modelo.
4. Vincula los campos del topic con los nodos seleccionados del modelo en todos los ejes de **Position** y **Rotation** según sea necesario.
5. En **Data Tagging**, añade tags estáticos al modelo y vincula datos UNS para mostrar información estática.
        :::tip
        Crea múltiples instancias de un mismo modelo para simular una línea de máquinas idénticas con datos diferentes.
        :::
6. Añade otros modelos necesarios para tu taller.
</Steps>

## Visualizar la escena del taller
<Steps>
1. En Tier0, ve a **Scene** y añade una nueva escena.
2. Añade desde **Instance Library** todas las instancias necesarias que existen en el taller.
3. Mueve los modelos de instancia a sus posiciones dentro del taller.
        :::tip[Cómo mover modelos a la posición correcta]
        - Cambia las herramientas superiores para mover, escalar y rotar el modelo, y ajustar la perspectiva de visualización y la posición de coordenadas.
        - Revisa **Object** a la derecha, donde se muestra el modelo UNS vinculado, para confirmar la posición del modelo.
        :::
4. Selecciona un modelo y configura el viewport y la iluminación.
5. Cuando termines la configuración, guarda la escena para mostrarla más adelante.
</Steps>

## Compartir externamente
<Steps>
1. Ve a **Model** y selecciona un modelo configurado en el taller.
2. Selecciona una instancia existente y genera un código QR.
3. Selecciona un modo de compartición y envía el código a terceros.
        - **Share Model**: genera un enlace de la plataforma Tier0 donde se muestra el modelo con datos UNS en vivo.
        - **Share Scene**: genera un enlace de la plataforma Tier0 donde se muestran el modelo, la escena donde está ubicado, los datos UNS en vivo y la configuración del entorno.
</Steps>
