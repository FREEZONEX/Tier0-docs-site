...
sidebar:
  order: 2
  label: Conexión OPC UA/Modbus/Rest API
---
...
<Steps>
1. Inicia sesión en Tier0, ve a **Flow** y crea un nuevo **Source Flow**.
2. Agrega los nodos **inject**, **OPC UA Client** y **mqtt out** al flow.
3. Conéctalos en orden y haz doble clic en cada nodo para configurar los detalles.
</Steps>
- **inject**
    <Steps>
...
2. Haz doble clic en los nodos y configura la información requerida.
    - **modbus-read**
        - **Settings**
          - **FC**: código de función que especifica la acción Modbus, por ejemplo FC 3 = leer registros holding.
          - **Address**: dirección inicial del registro que se va a leer (normalmente empieza en 0).
