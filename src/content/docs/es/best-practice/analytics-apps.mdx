...
```mermaid
flowchart LR
  collect["Node-RED"] -->|"datos recopilados"| uns[("Modelado<br/>UNS")]
...
2. Ve a **Flows**, crea un **Source Flow** para conectar los datos sin procesar y publicarlos en **UNS**.
    ...
    *(Node-RED conecta los datos y los publica en UNS.)*
    <details className="notebook-cell">
    <summary>Mostrar JSON de Source Flow</summary>
...
2. Abre el notebook y agrega las siguientes celdas para analizar datos de **UNS**.
    ...
    - Celda 1 - Importar librerías y configuración
      ...
      Importa las librerías necesarias y configura el broker MQTT, los topics y los ajustes de ejecución.
    ...
    - Celda 2 - Definir la estructura de Bayesian Network

      Define la topology de Bayesian Network, los espacios de estado, los generadores CPT y las reglas de probabilidad.
    ...
    - Celda 3 - Validar y discretizar los datos de origen

      Valida el payload MQTT entrante y convierte los valores continuos del proceso en estados de Bayesian Network.
    ...
    - Celda 4 - Construir el modelo y ejecutar inferencia

      Construye una Bayesian Network para el snapshot actual, ejecuta inferencia y genera payloads de salida.
    ...
    - Celda 5 - Ejecutar el servicio de análisis MQTT
    ...
    - Celda 6 - Mostrar el estado del servicio
    ...
    - Celda 7 - Mostrar el último resultado de análisis
...
2. Introduce los requisitos de la aplicación en el cuadro de diálogo y comienza la construcción.
    ...
    <Aside type="caution" title="Lo que debe indicarse">
    ...
    <details className="notebook-cell">
    <summary>Mostrar prompt de Builder</summary>
