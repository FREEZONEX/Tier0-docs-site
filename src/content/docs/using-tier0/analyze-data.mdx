...
<details className="notebook-cell">
<summary>Cell 2: Get data from UNS, clean it to get the analysis dataset.</summary>
...
<Steps>
3. Click **Run all stale cells** at the lower-right corner to run all cells and view the results.
</Steps>
...
- [UNS Concepts](/using-tier0/uns-concepts/) — Understand the data model you just analyzed.