...
3. Move instance models to their positions in the workshop.
        ...
        - Check the **Object** on the right, which displays the bound UNS model, to confirm the model position.
        :::
4. Select one model, and set the viewport and lighting.
5. Once the settings are complete, save the scene for future display.
</Steps>
