...
To connect data to Tier0, first build a model in **UNS**, then connect data sources through **Source Flow** to the model.
...
<Steps>
1. Copy the template JSON or download the template file on the **Import** window.
...
|------|-----------|------|-------------|
| Path | Custom Attributes | - | Use when you need to add additional attributes to the path, such as unit information. |
