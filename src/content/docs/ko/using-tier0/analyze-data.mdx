---
title: UNS 데이터 분석
description: Tier0 Notebook에서 live namespace data를 query하고 interactive analysis 및 machine-learning app을 구축합니다. Cloud와 Enterprise에서 사용할 수 있습니다.
...
### 예제 배경
- 데이터 소스는 공장에서 수집되어 Tier0 UNS로 전송된 압축기의 온도, 압력, 상태, 진동입니다.
...
오른쪽 위에서 보기 스타일을 **Vertical**, **Grid**, **Slides** 중 하나로 변경할 수 있습니다.
:::
