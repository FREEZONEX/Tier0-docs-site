...
## Building an 분석 App in Notebook
...
2. Access the notebook, and add the following cells to analyze data from **UNS**.
    ...
    - Cell 3 - Validate & Discretize Source Data
      ...
      들어오는 MQTT payload를 validate하고 continuous process value를 Bayesian Network state로 변환합니다.
    ...
    - Cell 4 - Build Model & Run Inference
      ...
      현재 snapshot에 대한 Bayesian Network를 구축하고 추론을 실행한 뒤 출력 payload를 생성합니다.
...
2. Enter the application requirements in the dialog, and start building.
    ...
    <Aside type="tip" title="In case you are building apps on another Tier0">
