---
title: Building Shopfloor Workflow with Agent
...
3. Once you confirm that the model is complete, enter the prompt and let the agent connect the corresponding data to the model.
    ...
    Tell the agent your data source information for connection.
    :::
...
:::note
Continue talking to the agent after each step to refine the outcome.
:::
