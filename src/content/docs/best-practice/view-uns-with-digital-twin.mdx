---
title: Display UNS Data with Digital Twin
description: View UNS data in 3D models and scenes in real time.
...
The digital twin feature in Tier0 enables you to view live UNS data on 3D models in lifelike scenes.

## Workshop Digital Twin
In this section, we bring a workshop to life. It contains the following machines:
- 2 lathes
...
## Collecting Data from Workshop
Publish all data to **UNS**, including data that controls machine movements and indicates machine status and the workshop environment.
<Steps>
1. Log in to Tier0, go to **UNS** and build the data models.
...
2. Go to **Flows**, create a **Source Flow** to connect data sources to UNS models.
        - Robot Arm
        <details className="notebook-cell">
        <summary>Show Robot Arm flow JSON</summary>
        ...
        - AGV
        <details className="notebook-cell">
        <summary>Show AGV flow JSON</summary>
        ...
        - Lathe 1
        <details className="notebook-cell">
        <summary>Show Lathe 1 flow JSON</summary>
        ...
        - Lathe 2
        <details className="notebook-cell">
        <summary>Show Lathe 2 flow JSON</summary>
...
<Steps>
1. In Tier0, go to **Model**.
2. Upload a model, select model nodes to which you want to map UNS data.
3. Create an instance, select the UNS topic for the node mapping, and set the real-world model height.
4. Bind the topic fields with the selected model nodes on all axes of **Position** and **Rotation** as needed.
5. Under **Data Tagging**, add static tags to the model and bind UNS data to them to display static information.

    :::tip
    Create multiple instances for one model to simulate a line of identical machines with different data.
    :::

6. Add other models necessary for your workshop.
</Steps>

## Visualizing Workshop Scene
<Steps>
1. In Tier0, go to **Scene** and add a new scene.
2. Add all necessary instances that exist in the workshop from **Instance Library**.
3. Move instance models to their positions in the workshop.

    :::tip[How to move models to the correct position]
    - Use the tools at the top to move, scale, and rotate the model, and to change the viewing perspective and coordinate position.
    - Check the **Object** on the right, which displays the bound UNS model, to help confirm the model position.
    :::

4. Select a model, and set its viewport and lighting.
5. Do the same for all models, once the settings are complete, save the scene for future display.
</Steps>

## External Share
<Steps>
1. Go to **Model**, select a configured model in the workshop.
2. Select an existing instance, generate a QR code.
3. Select a sharing mode, and send the code to external parties.
