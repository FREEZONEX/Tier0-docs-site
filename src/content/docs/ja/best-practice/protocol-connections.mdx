---
title: 産業プロトコルの接続
description: "Node-RED を使って OPC UA、Modbus、その他の典型的なプロトコルデバイスを UNS に接続し、実際の flow JSON 参照を提供します。"
...
<details>
<summary>OPC UA flow JSON を表示</summary>
...
<details>
<summary>Modbus flow JSON を表示</summary>
...
### Flow Reference
<details>
<summary>API flow JSON を表示</summary>
...
- **UNS** に publish する前に、必要に応じて **function** ノードでデータを整形できます。
- **debug** ノードを使って、その場でデータを確認できます。
- ノードの詳細は [Node-RED flows](https://flows.nodered.org/) を参照してください。
:::
