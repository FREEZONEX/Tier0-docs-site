---
title: 分析 UNS 数据
description: "在 Tier0 Notebook 中查询实时 namespace 数据，并构建交互式分析和机器学习应用。"
...
:::
<Steps>
1. 创建一个 notebook，然后单击内部左侧的 **VARIABLES**。
2. 展开 **PostgreSQL** 列表，在 **tenant_id** > **uns** 下选择一张表。
3. 单击表旁边的 **+** 图标，自动生成默认 cell 和 SQL 命令 cell。
...
<details className="notebook-cell">
<summary>Cell 3：设置异常检测灵敏度滑块。</summary>
...
- [UNS 概念](../uns-concepts/) — 理解在统一命名空间中数据建模的概念
